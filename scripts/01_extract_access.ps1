...
Write-Host ""
Write-Host "EXPECTED VALUES FOR THIS DATABASE -- verify before proceeding:" -ForegroundColor Cyan
Write-Host "   العملاء            313 rows,  54 attachments (logo)"
Write-Host "   خطابات الأتعاب     331 rows, 288 mvf values across 195 parents"
Write-Host "   الجلسات         13,279 rows"
Write-Host "   admin work table  4,207 rows"
Write-Host "   إجراءات المهام    4,130 rows"
Write-Host "   الدعاوى           1,730 rows"
Write-Host ""
Write-Host "If attachments = 0 or mvf values = 0, the extraction FAILED silently." -ForegroundColor Yellow
Write-Host "Do not proceed to Stage B." -ForegroundColor Yellow
Write-Host ""
