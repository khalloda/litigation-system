 ...
 *
 * There are 150 seed rows across nine lists, almost all Arabic. Several pairs
 * differ by a single character — محكمة, محكمه and مجكمة are three distinct
 * hearing actions the firm chose to keep apart, and أول درجة and ابتدائي are
...
out.push('--');
out.push('--  GENERATED by scripts/generate-lookup-seed.ts from the two SQL files the');
out.push('--  firm reviewed value by value. Do not hand-edit this section: change the');
out.push('--  source and regenerate, or the two will drift apart.');
out.push('--');
