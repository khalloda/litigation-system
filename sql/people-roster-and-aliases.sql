...
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'خالد عطيه', 1 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وشريف أبو المكارم صالح وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'أحمد عبد الله', 2 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وشريف أبو المكارم صالح وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'محمد عبد العزيز عبد الحافظ', 3 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وشريف أبو المكارم صالح وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'شريف أبو المكارم', 4 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وشريف أبو المكارم صالح وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'أحمد سعيد', 5 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وشريف أبو المكارم صالح وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'محمد الغرابلي', 6 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وشريف أبو المكارم صالح وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
...
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'خالد عطيه', 1 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'أحمد عبد الله', 2 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'محمد عبد العزيز عبد الحافظ', 3 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'أحمد سعيد', 4 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'محمد الغرابلي', 5 FROM migration_multi_person_rule WHERE raw_value = 'خالد محمود حمدي عبد العزيز وأحمد عبد الله محمد ومحمد عبد العزيز عبد الحافظ وأحمد سعيد أحمد ومحمد مجدي أحمد الغرابلي';
...
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'هاني سري الدين', 1 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'أميرة شريف', 2 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'إيهاب حمدي', 3 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'محمد عبد العزيز', 4 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'أحمد سعيد', 5 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'محمد حمدي', 6 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'هاني الدالي', 7 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
INSERT INTO migration_multi_person_member (rule_id, person_name, ordinal) SELECT id, 'عبد الرحمن البنا', 8 FROM migration_multi_person_rule WHERE raw_value = 'هاني سري الدين - أميرة شريف - إيهاب حمدي - محمد عبد العزيز - أحمد سعيد - محمد حمدي - هاني الدالي - عبد الرحمن البنا';
