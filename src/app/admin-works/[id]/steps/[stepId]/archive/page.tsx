...
export const metadata: Metadata = { title: t.adminWorks.lifecycle.archiveStep };
export default async function Page({
  ...
  const session = await requirePagePermission({ area: 'administrativeWorks', action: 'archive' });
