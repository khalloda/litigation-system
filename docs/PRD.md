...
At that Task 4.4 closure checkpoint, Task 4.5 was unstarted. No migration, rebuild,
restart, login or database test was part of that documentation continuation.
